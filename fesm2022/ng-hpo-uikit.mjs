...
import { signal, Injectable, inject, input, output, computed, Component, viewChild, HostListener, ViewChild, model, afterNextRender, effect, EventEmitter, Output, Input } from '@angular/core';
...
class NotificationService {
    ...
    push(message, kind, dismissLabel, duration) {
...
const ICON_PATHS = {
    ...
    assignment: 'M19 3h-4.18C14.4 1.84 13.3 1 12 1s-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm7 18H5V5h2v3h10V5h2v16z',
    ...
    delete_outline: 'M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z',
    ...
    fingerprint: 'M17.81 4.47c-.08.03-.16.07-.25.13C14.95 6.01 13 8.71 13 12c0 3.29 1.95 5.99 4.56 7.4.09.06.17.1.25.13.38.19.53.65.34 1.03-.19.38-.65.53-1.03.34C13.88 19.03 11 15.82 11 12c0-3.82 2.88-7.03 6.36-8.9.38-.19.84-.04 1.03.34.19.38.04.84-.34 1.03zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm0-14c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z',
    group_add: 'M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z', health_and_safety: 'M10.5 13H8v-3h2.5V7.5h3V10H16v3h-2.5v2.5h-3V13zM12 2l-8 3v7c0 5.25 3.43 10.14 8 11.35 4.57-1.21 8-6.1 8-11.35V5l-8-3zm6 9.91C18 15.63 15.36 19.04 12 20.88 8.64 19.04 6 15.63 6 11.91V6.3l6-2.25 6 2.25v5.61z',
    ...
    medical_services: 'M20 6h-4V4c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v2H4c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zM10 4h4v2h-4V4zm10 15H4V8h16v11zM13 10h-2v3H8v2h3v3h2v-3h3v-2h-3z',
    ...
    science: 'M19.36 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.64-4.96zM19 18H6c-2.21 0-4-1.79-4-4 0-2.05 1.53-3.76 3.56-3.97l1.07-.11.5-.95C8.08 7.14 9.94 6 12 6c2.62 0 4.88 1.86 5.39 4.43l.3 1.5 1.53.11c1.56.1 2.78 1.39 2.78 2.96 0 1.65-1.35 3-3 3zM8 13h2v2H8zm4 0h2v2h-2zm4 0h2v2h-2z',
    sort: 'M3 18h6v-2H3v2zM3 6v2h18V6H3zm0 7h12v-2H3v5z',
    subject: 'M14 17H4v2h10v-2zm6-8H4v2h16V9zM4 13h16v-2H4v2zm0-8v2h16V5H4z',
    table_chart: 'M10 10.02h5V21h-5V10.02zM17 21h3c1.1 0 2-.9 2-2v-9h-5v11zM3 3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h3V3H3zm19 3v2H2V6h20zm-7-3H5v4h10V3z',
    warning: 'M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z',
};
class IconComponent {
    name = input.required(...(ngDevMode ? [{ debugName: "name" }] : /* istanbul ignore next */ []));
    size = input(20, ...(ngDevMode ? [{ debugName: "size" }] : /* istanbul ignore next */ []));
    path = computed(() => ICON_PATHS[this.name()] ?? '', ...(ngDevMode ? [{ debugName: "path" }] : /* istanbul ignore next */ []));
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.2.17", type: IconComponent, isStandalone: true, selector: "app-icon", inputs: { name: { classPropertyName: "name", publicName: "name", isSignal: true, isRequired: true, transformFunction: null }, size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: `
...
class HpoModifierDialogComponent {
    data = input.required(...(ngDevMode ? [{ debugName: "data" }] : /* istanbul ignore next */ []));
    done = output();
    currentSelection = signal([], ...(ngDevMode ? [{ debugName: "currentSelection" }] : /* istanbul ignore next */ []));
    dialogEl;
    emitted = false;
    constructor() {
        afterNextRender(() => {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: HpoModifierDialogComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.2.17", type: HpoModifierDialogComponent, isStandalone: true, selector: "hpo-modifier-dialog", inputs: { data: { classPropertyName: "data", publicName: "data", isSignal: true, isRequired: true, transformFunction: null } }, outputs: { done: "done" }, viewQueries: [{ propertyName: "dialogEl", first: true, predicate: ["modifierDialogEl"], descendants: true }], ngImport: i0, template: `
  ...
  `, isInline: true, styles: [":host{display:contents}.orcid-modal{border:none;border-radius:8px;padding:0;width:380px;max-width:90vw;box-shadow:0 8px 24px #0003}.orcid-modal::backdrop{background:#00000080}.modifier-dialog-shell{display:flex;flex-direction:column}\n"], dependencies: [{ kind: "component", type: HpoModifierComponent, selector: "hpo-modifier", inputs: ["availableModifiers", "selectedModifiers", "placeholder"], outputs: ["selectedModifiersChange", "modifierToggled", "menuClosed"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: HpoModifierDialogComponent, decorators: [{
            type: Component,
            args: [{ selector: 'hpo-modifier-dialog', standalone: true, imports: [HpoModifierComponent], template: `
    <dialog #modifierDialogEl (close)="onNativeClose()" class="orcid-modal modifier-dialog-modal">
      <div class="modifier-dialog-shell">
        <hpo-modifier
          [availableModifiers]="data().availableModifiers"
  ...
  `, styles: [":host{display:contents}.orcid-modal{border:none;border-radius:8px;padding:0;width:380px;max-width:90vw;box-shadow:0 8px 24px #0003}.orcid-modal::backdrop{background:#00000080}.modifier-dialog-shell{display:flex;flex-direction:column}\n"] }]
        }], ctorParameters: () => [], propDecorators: { data: [{ type: i0.Input, args: [{ isSignal: true, alias: "data", required: true }] }], done: [{ type: i0.Output, args: ["done"] }], dialogEl: [{
                type: ViewChild,
                args: ['modifierDialogEl']
            }] } });
...
class HpoPolishRowComponent {
    ...
    triggerEl = viewChild.required('hierarchyTrigger');
    menuPosition = signal({ top: 0, left: 0 }, ...(ngDevMode ? [{ debugName: "menuPosition" }] : /* istanbul ignore next */ []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: HpoPolishRowComponent, decorators: [{
            ...
            args: [{ selector: 'tr[hpo-polisher-row]', standalone: true, imports: [
                    ...
                    ], template: "  <td class=\"hpo-id-cell\">\n     <a \n      [href]=\"'https://hpo.jax.org/browse/term/' + annotation().termId\"\n      target=\"_blank\"\n      rel=\"noopener\"\n      class=\"link-text\">\n      {{ annotation().termId }}\n    </a>\n  </td>\n\n  <td class=\"label-cell\">\n    <div class=\"dropdown-wrapper\">\n    <span\n      #hierarchyTrigger\n      (click)=\"openHierarchyMenu()\"\n      class=\"dropdown-trigger\">\n        {{ annotation().label }} <span class=\"caret\">\u25BC</span>\n    </span>\n\n    @if (showHierarchyMenu()) {\n  <div class=\"local-context-menu\" [style.top.px]=\"menuPosition().top\" [style.left.px]=\"menuPosition().left\" (mouseleave)=\"showHierarchyMenu.set(false)\">\n    @if (hierarchy()?.parents?.length) {\n        <div class=\"menu-section-title\">Parents</div>\n        <ul>\n        @for (p of hierarchy()?.parents; track p.termId) {\n            <li (click)=\"replaceTerm(p)\" class=\"menu-item\">{{ p.label }} ({{ p.termId }})</li>\n        }\n        </ul>\n    }\n    @if (hierarchy()?.children?.length) {\n        <div class=\"menu-section-title\">Children</div>\n        <ul>\n        @for (c of hierarchy()?.children; track c.termId) {\n            <li (click)=\"replaceTerm(c)\" class=\"menu-item\">{{ c.label }} ({{ c.termId }})</li>\n        }\n        </ul>\n    }\n    @if (!hierarchy()) {\n      <div class=\"menu-item-empty\">Loading\u2026</div>\n    } @else if (!hierarchy()?.parents?.length && !hierarchy()?.children?.length) {\n      <div class=\"menu-item-empty\">No related terms found</div>\n    }\n  </div>\n}\n    </div>\n</td>\n\n  <td>\n      <span class=\"badge\" [ngClass]=\"annotation().excluded ?  'badge-red' : 'badge-green'\">\n      {{ annotation().excluded ?  'EXC' : 'OBS' }}\n      </span>\n  </td>\n\n  <td class=\"onset-cell\">\n    <hpo-age-selector\n      size=\"small\"\n      [selectedOnset]=\"annotation().onsetString || null\"\n      (onsetChanged)=\"changeOnset($event)\"\n    />\n  </td>\n\n  <td class=\"modifier-cell\">\n    <div class=\"active-modifiers-preview\" (click)=\"toggleModifierModal()\">\n      @for (mod of annotation().modifiers?.slice(0,2) ?? []; track mod.termId) {\n        <span class=\"modifier-chip\"\n                [title]=\"mod.label\">\n             {{ mod.label.length > 10 ? mod.label.slice(0, 10) + '\u2026' : mod.label }}\n        </span>\n        }\n\n        @if ((annotation().modifiers?.length ?? 0) > 2) {\n        <span\n            class=\"modifier-chip more\"\n            [title]=\"remainingModifierLabels()\">\n            +{{ (annotation().modifiers?.length ?? 0) - 2 }}\n        </span>\n        }\n        <button\n            class=\"annotation-action\"\n            (click)=\"toggleModifierModal(); $event.stopPropagation()\">\n            {{ modifierButtonText() }}\n        </button>\n    </div>\n    @if (isModifierDialogOpen()) {\n        <hpo-modifier-dialog\n            [data]=\"{ availableModifiers: availableModifiers(), selectedModifiers: annotation().modifiers ?? [] }\"\n            (done)=\"onModifierDialogDone($event)\"\n        />\n    }\n  </td>\n\n  <td class=\"action-cell\">\n      <div class=\"action-group\">\n        <button\n            title=\"Toggle observed/excluded\"\n            (click)=\"toggleObserved()\">\n            <svg viewBox=\"0 0 24 24\" width=\"18\" height=\"18\" fill=\"currentColor\">\n                <path d=\"M6.99 11L3 15l3.99 4v-3H14v-2H6.99v-3zM21 9l-3.99-4v3H10v2h7.01v3L21 9z\"/>\n            </svg>\n        </button>\n\n        <button\n            color=\"warn\"\n            title=\"Delete annotation\"\n            (click)=\"deleteRequested.emit()\">\n            \uD83D\uDDD1\n        </button>\n    </div>\n  </td>", styles: [":host{display:table-row;--border-color: #e5e7eb;--bg-gray-light: #f9fafb;--text-gray-dark: #374151;--text-gray-muted: #6b7280;--green-bg: #dcfce7;--green-text: #15803d;--red-bg: #fee2e2;--red-text: #b91c1c;--blue-primary: #2563eb;--blue-hover: #1d4ed8;--shadow: 0 4px 6px -1px rgba(0, 0, 0, .1), 0 2px 4px -1px rgba(0, 0, 0, .06)}.label-cell{position:relative}.dropdown-wrapper{position:relative;display:inline-block}.dropdown-trigger{cursor:pointer;color:#0d6efd;font-weight:500}.dropdown-trigger:hover{text-decoration:underline}.local-context-menu{position:fixed;z-index:20;background:#fff;border:1px solid #e2e8f0;border-radius:8px;box-shadow:0 4px 12px #00000026;min-width:260px;max-height:300px;overflow-y:auto}.menu-section-title{background:#f8f9fa;padding:6px 12px;font-weight:700;font-size:11px;text-transform:uppercase;color:#6c757d}.menu-item{padding:4px 6px;font-size:13px;cursor:pointer;list-style:none}.menu-item:hover{background-color:#f1f3f5}td{padding:4px 8px;vertical-align:middle}.modifiers-container{display:flex;flex-wrap:wrap;gap:4px;align-items:center}.modifier-chip{background:#e9ecef;border-radius:12px;padding:1px 6px;font-size:8px;display:inline-flex;align-items:center;gap:4px;max-width:90px}.modifier-chip.more{cursor:help}.remove-mod-btn{border:none;background:transparent;cursor:pointer;font-weight:700;color:#dc3545}.modifier-select,.onset-select{padding:4px;border-radius:4px;border:1px solid #ced4da;font-size:11px}.active-modifiers-preview{display:flex;flex-wrap:wrap;gap:2px;align-items:center;min-height:22px}.badge{padding:.125rem .375rem;border-radius:9999px;font-size:8px;font-weight:700;padding:1px 5px}.badge.badge-green{background:var(--green-bg);color:var(--green-text)}.badge.badge-red{background:var(--red-bg);color:var(--red-text)}.action-group{display:flex;gap:8px;align-items:center}.action-group button{background:none;border:none;cursor:pointer;padding:4px;display:flex;align-items:center;justify-content:center;border-radius:4px}.action-group button:hover{background-color:#f0f0f0}.hpo-id-cell{font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace}\n"] }]
        }], ctorParameters: () => [], propDecorators: { annotation: [{ type: i0.Input, args: [{ isSignal: true, alias: "annotation", required: true }] }, { type: i0.Output, args: ["annotationChange"] }], hierarchyProvider: [{ type: i0.Input, args: [{ isSignal: true, alias: "hierarchyProvider", required: true }] }], availableModifiers: [{ type: i0.Input, args: [{ isSignal: true, alias: "availableModifiers", required: false }] }], updated: [{ type: i0.Output, args: ["updated"] }], deleteRequested: [{ type: i0.Output, args: ["deleteRequested"] }], termClick: [{ type: i0.Output, args: ["termClick"] }], triggerEl: [{ type: i0.ViewChild, args: ['hierarchyTrigger', { isSignal: true }] }] } });
...
class OntologyAutocompleteComponent {
    ...
    popupMenuDirection = input('up', ...(ngDevMode ? [{ debugName: "popupMenuDirection" }] : /* istanbul ignore next */ []));
    ;
    selected = output();
...
const gestWeeksToRelativeDays = (weeks) => weeks * 7 - TERM_GESTATION_DAYS;
/**
...
function parseIsoDurationDays(raw) {
    const m = /^P(?:(\d+(?:\.\d+)?)Y)?(?:(\d+(?:\.\d+)?)M)?(?:(\d+(?:\.\d+)?)W)?(?:(\d+(?:\.\d+)?)D)?$/i.exec(raw);
    if (!m || raw.toUpperCase() === 'P')
        return null;
    const [, y, mo, w, d] = m;
    if (!y && !mo && !w && !d)
        return null;
...
function parseGestationalAgeDays(raw) {
...
function parseOnsetToDays(onset) {
    if (onset == null)
        return null;
    const raw = onset.trim();
    if (isEmptyOnsetToken(raw))
        return null;
...
function isEmptyOnsetToken(raw) {
    if (!raw)
        return true;
    return raw === "na";
}
class OnsetSortService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: OnsetSortService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: OnsetSortService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: OnsetSortService, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }] });
...
class HpoPolishingWorkspaceComponent {
    onsetSort = inject(OnsetSortService);
    sentences = input([], ...(ngDevMode ? [{ debugName: "sentences" }] : /* istanbul ignore next */ []));
...
class HpoMiningComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.2.17", type: HpoMiningComponent, isStandalone: true, selector: "hpo-mining-workspace", outputs: { success: "success", error: "error", cancel: "cancel", miningRequested: "miningRequested" }, ngImport: i0, template: "<div class=\"clinical-text-container\">\n  <label for=\"clinical-text\" class=\"hpo-label\">Paste clinical text</label>\n  <div class=\"input-section\">\n    <textarea\n      id=\"clinical-text\"\n      [(ngModel)]=\"pastedText\"\n      rows=\"15\"\n      placeholder=\"Paste here with ctrl-V...\"\n      class=\"clinical-textarea\"\n      [disabled]=\"isMining()\"\n    ></textarea>\n    <a \n      href=\"javascript:void(0)\" \n      (click)=\"!isMining() && loadExampleText()\" \n      class=\"example-text-link\"\n      [class.disabled]=\"isMining()\">\n      Load Example Text\n    </a>\n    \n    <div class=\"actions-footer\">\n      <button \n        (click)=\"runTextMining()\"  \n        class=\"btn-outline-primary\"\n        [disabled]=\"isMining() || !pastedText.trim()\">\n        {{ isMining() ? 'Processing Text...' : 'Run HPO Text Mining' }}\n      </button>\n      <button \n        class=\"btn-outline-cancel\" \n        (click)=\"onCancel()\"\n        [disabled]=\"isMining()\">\n        Cancel\n      </button>\n    </div>\n  </div>\n</div>", styles: ["*{box-sizing:border-box}:host{display:flex;flex-direction:column;width:100%;height:100%}.clinical-text-container{width:100%;display:flex;flex-direction:column;flex:1;gap:1rem}.hpo-label{font-family:var(--hpo-font-sans);font-size:12px;font-weight:600;color:#334155;letter-spacing:.5px}.input-section{display:flex;flex-direction:column;align-items:stretch;flex:1;width:100%;position:relative}.clinical-textarea{display:block;width:100%;min-height:450px;font-family:Fira Code,monospace;padding-right:7rem;padding:1rem;border:2px solid #d1d5db;border-radius:8px;resize:vertical}.example-text-link{position:absolute;right:8px;bottom:8px;font-size:11px;color:#999;text-decoration:none;opacity:.7;transition:opacity .15s ease,color .15s ease}.example-text-link:hover{opacity:1;color:#666;text-decoration:underline}.example-text-link.disabled{pointer-events:none;opacity:.3}.actions-footer{display:flex;justify-content:flex-start;align-items:center;gap:8px;margin-top:8px}.btn-cluster{display:flex;gap:8px}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "ngmodule", type: FormsModule }, { kind: "directive", type: i1.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i1.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }] });
}
...
class OrcidDialogComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: OrcidDialogComponent, isStandalone: true, selector: "app-orcid-dialog", inputs: { currentOrcid: "currentOrcid" }, outputs: { closed: "closed" }, viewQueries: [{ propertyName: "dialogEl", first: true, predicate: ["dialogEl"], descendants: true }], ngImport: i0, template: " <dialog #dialogEl class=\"orcid-modal\">\n      <div class=\"dialog-content\">\n        <h2 class=\"dialog-title\">Enter ORCID researcher identifier</h2>\n\n        <div class=\"dialog-body\">\n          <form [formGroup]=\"orcidForm\" class=\"orcid-form\">\n            <div class=\"input-group\">\n              <label for=\"orcid-input\" class=\"input-label\">ORCID ID</label>\n              <input\n                id=\"orcid-input\"\n                type=\"text\"\n                formControlName=\"orcid\"\n                placeholder=\"0000-0000-0000-0000\"\n                maxlength=\"19\"\n                class=\"orcid-text-input\"\n                [class.invalid]=\"orcidForm.get('orcid')?.invalid && orcidForm.get('orcid')?.touched\"\n              />\n              <span class=\"input-hint\">Format: 0000-0000-0000-0000</span>\n              \n              @if (orcidForm.get('orcid')?.touched && orcidForm.get('orcid')?.hasError('required')) {\n                <span class=\"error-msg\">ORCID is required</span>\n              }\n              @if (orcidForm.get('orcid')?.touched && orcidForm.get('orcid')?.hasError('pattern')) {\n                <span class=\"error-msg\">Invalid ORCID format</span>\n              }\n            </div>\n          </form>\n\n          <div class=\"orcid-info\">\n            <app-icon name=\"info\" [size]=\"20\" />\n            <span>\n              ORCID provides a persistent digital identifier for researchers.\n              <a href=\"https://orcid.org/\" target=\"_blank\" class=\"info-link\">Learn more</a>\n            </span>\n          </div>\n        </div>\n\n        <div class=\"dialog-actions\">\n          <button\n            type=\"button\"\n            (click)=\"onCancel()\"\n            class=\"btn-outline-primary px-6 py-2 min-w-[100px]\"\n          >\n            Cancel\n          </button>\n          <button\n            type=\"button\"\n            (click)=\"onSave()\"\n            [disabled]=\"orcidForm.invalid\"\n            class=\"btn-outline-primary px-6 py-2 min-w-[100px] save-btn\"\n          >\n            Save\n          </button>\n        </div>\n      </div>\n    </dialog>", styles: ["dialog.orcid-modal{border:none;background:transparent;padding:0;border-radius:8px;box-shadow:0 20px 25px -5px #0000001a,0 10px 10px -5px #0000000a;width:100%;max-width:450px}dialog.orcid-modal::backdrop{background-color:#00000080;-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px)}dialog.orcid-modal:not([open]){display:none}.dialog-content{background:#fff;padding:24px;display:flex;flex-direction:column}.dialog-title{margin:0 0 16px;font-size:1.25rem;font-weight:600;color:#1f2937}.dialog-body{padding-top:8px}.orcid-form{margin-top:8px}.input-group{display:flex;flex-direction:column;gap:4px}.input-label{font-size:.875rem;font-weight:500;color:#374151}.orcid-text-input{width:100%;padding:8px 12px;border:1px solid #d1d5db;border-radius:6px;font-size:1rem;outline:none;box-sizing:border-box}.orcid-text-input:focus{border-color:#3b82f6;box-shadow:0 0 0 2px #3b82f633}.orcid-text-input.invalid{border-color:#ef4444}.input-hint{font-size:.75rem;color:#6b7280}.error-msg{font-size:.75rem;color:#dc2626}.orcid-info{background:#f8f9fa;padding:12px;border-radius:6px;margin-top:20px;font-size:13px;display:flex;align-items:center;gap:10px;color:#4b5563;border:1px solid #e5e7eb}.info-link{color:#2563eb;text-decoration:underline}.dialog-actions{margin-top:24px;display:flex;justify-content:flex-end;gap:12px}.save-btn:disabled{opacity:.5;cursor:not-allowed}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "ngmodule", type: ReactiveFormsModule }, { kind: "directive", type: i1.ɵNgNoValidate, selector: "form:not([ngNoForm]):not([ngNativeValidate])" }, { kind: "directive", type: i1.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { kind: "directive", type: i1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { kind: "directive", type: i1.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],[formArray],form:not([ngNoForm]),[ngForm]" }, { kind: "directive", type: i1.MaxLengthValidator, selector: "[maxlength][formControlName],[maxlength][formControl],[maxlength][ngModel]", inputs: ["maxlength"] }, { kind: "directive", type: i1.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { kind: "directive", type: i1.FormControlName, selector: "[formControlName]", inputs: ["formControlName", "disabled", "ngModel"], outputs: ["ngModelChange"] }, { kind: "component", type: IconComponent, selector: "app-icon", inputs: ["name", "size"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: OrcidDialogComponent, decorators: [{
            type: Component,
            args: [{ selector: 'app-orcid-dialog', standalone: true, imports: [CommonModule, ReactiveFormsModule, IconComponent], template: " <dialog #dialogEl class=\"orcid-modal\">\n      <div class=\"dialog-content\">\n        <h2 class=\"dialog-title\">Enter ORCID researcher identifier</h2>\n\n        <div class=\"dialog-body\">\n          <form [formGroup]=\"orcidForm\" class=\"orcid-form\">\n            <div class=\"input-group\">\n              <label for=\"orcid-input\" class=\"input-label\">ORCID ID</label>\n              <input\n                id=\"orcid-input\"\n                type=\"text\"\n                formControlName=\"orcid\"\n                placeholder=\"0000-0000-0000-0000\"\n                maxlength=\"19\"\n                class=\"orcid-text-input\"\n                [class.invalid]=\"orcidForm.get('orcid')?.invalid && orcidForm.get('orcid')?.touched\"\n              />\n              <span class=\"input-hint\">Format: 0000-0000-0000-0000</span>\n              \n              @if (orcidForm.get('orcid')?.touched && orcidForm.get('orcid')?.hasError('required')) {\n                <span class=\"error-msg\">ORCID is required</span>\n              }\n              @if (orcidForm.get('orcid')?.touched && orcidForm.get('orcid')?.hasError('pattern')) {\n                <span class=\"error-msg\">Invalid ORCID format</span>\n              }\n            </div>\n          </form>\n\n          <div class=\"orcid-info\">\n            <app-icon name=\"info\" [size]=\"20\" />\n            <span>\n              ORCID provides a persistent digital identifier for researchers.\n              <a href=\"https://orcid.org/\" target=\"_blank\" class=\"info-link\">Learn more</a>\n            </span>\n          </div>\n        </div>\n\n        <div class=\"dialog-actions\">\n          <button\n            type=\"button\"\n            (click)=\"onCancel()\"\n            class=\"btn-outline-primary px-6 py-2 min-w-[100px]\"\n          >\n            Cancel\n          </button>\n          <button\n            type=\"button\"\n            (click)=\"onSave()\"\n            [disabled]=\"orcidForm.invalid\"\n            class=\"btn-outline-primary px-6 py-2 min-w-[100px] save-btn\"\n          >\n            Save\n          </button>\n        </div>\n      </div>\n    </dialog>", styles: ["dialog.orcid-modal{border:none;background:transparent;padding:0;border-radius:8px;box-shadow:0 20px 25px -5px #0000001a,0 10px 10px -5px #0000000a;width:100%;max-width:450px}dialog.orcid-modal::backdrop{background-color:#00000080;-webkit-backdrop-filter:blur(4px);backdrop-filter:blur(4px)}dialog.orcid-modal:not([open]){display:none}.dialog-content{background:#fff;padding:24px;display:flex;flex-direction:column}.dialog-title{margin:0 0 16px;font-size:1.25rem;font-weight:600;color:#1f2937}.dialog-body{padding-top:8px}.orcid-form{margin-top:8px}.input-group{display:flex;flex-direction:column;gap:4px}.input-label{font-size:.875rem;font-weight:500;color:#374151}.orcid-text-input{width:100%;padding:8px 12px;border:1px solid #d1d5db;border-radius:6px;font-size:1rem;outline:none;box-sizing:border-box}.orcid-text-input:focus{border-color:#3b82f6;box-shadow:0 0 0 2px #3b82f633}.orcid-text-input.invalid{border-color:#ef4444}.input-hint{font-size:.75rem;color:#6b7280}.error-msg{font-size:.75rem;color:#dc2626}.orcid-info{background:#f8f9fa;padding:12px;border-radius:6px;margin-top:20px;font-size:13px;display:flex;align-items:center;gap:10px;color:#4b5563;border:1px solid #e5e7eb}.info-link{color:#2563eb;text-decoration:underline}.dialog-actions{margin-top:24px;display:flex;justify-content:flex-end;gap:12px}.save-btn:disabled{opacity:.5;cursor:not-allowed}\n"] }]
        }], propDecorators: { currentOrcid: [{
                type: Input
            }], closed: [{
                type: Output
            }], dialogEl: [{
...
class DocumentButtonComponent {
    ...
    clicked = output();
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: DocumentButtonComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: DocumentButtonComponent, isStandalone: true, selector: "hpo-document-button", inputs: { label: { classPropertyName: "label", publicName: "label", isSignal: true, isRequired: true, transformFunction: null }, text: { classPropertyName: "text", publicName: "text", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { clicked: "clicked" }, ngImport: i0, template: "<button class=\"btn-edit\" (click)=\"clicked.emit()\" [title]=\"label()\">\n  <svg\n    xmlns=\"http://www.w3.org/2000/svg\"\n    width=\"14\"\n    height=\"14\"\n    viewBox=\"0 0 24 24\"\n    fill=\"none\"\n    stroke=\"currentColor\"\n    stroke-width=\"2.5\"\n    stroke-linecap=\"round\"\n    stroke-linejoin=\"round\"\n  >\n    <path d=\"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z\"></path>\n    <polyline points=\"14 2 14 8 20 8\"></polyline>\n    <line x1=\"16\" y1=\"13\" x2=\"8\" y2=\"13\"></line>\n    <line x1=\"16\" y1=\"17\" x2=\"8\" y2=\"17\"></line>\n  </svg>\n  @if (text()) {\n    <span>{{ text() }}</span>\n  }\n</button>", styles: [".btn-edit{display:inline-flex;align-items:center;gap:4px;background-color:#f0f4f8;color:#06c;border:1px solid #cbd5e1;border-radius:4px;font-family:inherit;font-size:11px;font-weight:600;padding:3px 8px;cursor:pointer;white-space:nowrap;transition:all .1s ease}.btn-edit:hover{background-color:#06c;color:#fff;border-color:#06c}.btn-edit:active{transform:scale(.96)}\n"] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: DocumentButtonComponent, decorators: [{
            type: Component,
            args: [{ selector: 'hpo-document-button', standalone: true, template: "<button class=\"btn-edit\" (click)=\"clicked.emit()\" [title]=\"label()\">\n  <svg\n    xmlns=\"http://www.w3.org/2000/svg\"\n    width=\"14\"\n    height=\"14\"\n    viewBox=\"0 0 24 24\"\n    fill=\"none\"\n    stroke=\"currentColor\"\n    stroke-width=\"2.5\"\n    stroke-linecap=\"round\"\n    stroke-linejoin=\"round\"\n  >\n    <path d=\"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z\"></path>\n    <polyline points=\"14 2 14 8 20 8\"></polyline>\n    <line x1=\"16\" y1=\"13\" x2=\"8\" y2=\"13\"></line>\n    <line x1=\"16\" y1=\"17\" x2=\"8\" y2=\"17\"></line>\n  </svg>\n  @if (text()) {\n    <span>{{ text() }}</span>\n  }\n</button>", styles: [".btn-edit{display:inline-flex;align-items:center;gap:4px;background-color:#f0f4f8;color:#06c;border:1px solid #cbd5e1;border-radius:4px;font-family:inherit;font-size:11px;font-weight:600;padding:3px 8px;cursor:pointer;white-space:nowrap;transition:all .1s ease}.btn-edit:hover{background-color:#06c;color:#fff;border-color:#06c}.btn-edit:active{transform:scale(.96)}\n"] }]
        }], propDecorators: { label: [{ type: i0.Input, args: [{ isSignal: true, alias: "label", required: true }] }], text: [{ type: i0.Input, args: [{ isSignal: true, alias: "text", required: false }] }], clicked: [{ type: i0.Output, args: ["clicked"] }] } });
...
class ToastContainerComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.2.17", type: ToastContainerComponent, isStandalone: true, selector: "app-toast-container", viewQueries: [{ propertyName: "popoverEl", first: true, predicate: ["popoverEl"], descendants: true, isSignal: true }], ngImport: i0, template: `
  ...
  `, isInline: true, styles: [".toast-stack{position:fixed;inset:auto 0 24px;margin:0 auto;width:max-content;max-width:90vw;border:none;padding:0;background:transparent;display:flex;flex-direction:column;align-items:center;gap:8px;pointer-events:none}.toast{pointer-events:auto;display:flex;align-items:center;gap:12px;padding:10px 16px;border-radius:8px;color:#fff;font-size:.9rem;box-shadow:0 4px 12px #0003}.toast-error{background:#b00020}.toast-success{background:#2e7d32}.toast-warning{background:#b45309}.toast-dismiss{background:transparent;border:none;color:inherit;font-weight:600;text-decoration:underline;cursor:pointer}\n"] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.17", ngImport: i0, type: ToastContainerComponent, decorators: [{
            type: Component,
            args: [{ selector: 'app-toast-container', standalone: true, template: `
    <div #popoverEl popover="manual" class="toast-stack">
      @for (toast of notificationService.toasts(); track toast.id) {
        <div class="toast" [class]="'toast-' + toast.kind">
          <span class="toast-message">{{ toast.message }}</span>
  ...
  `, styles: [".toast-stack{position:fixed;inset:auto 0 24px;margin:0 auto;width:max-content;max-width:90vw;border:none;padding:0;background:transparent;display:flex;flex-direction:column;align-items:center;gap:8px;pointer-events:none}.toast{pointer-events:auto;display:flex;align-items:center;gap:12px;padding:10px 16px;border-radius:8px;color:#fff;font-size:.9rem;box-shadow:0 4px 12px #0003}.toast-error{background:#b00020}.toast-success{background:#2e7d32}.toast-warning{background:#b45309}.toast-dismiss{background:transparent;border:none;color:inherit;font-weight:600;text-decoration:underline;cursor:pointer}\n"] }]
        }], ctorParameters: () => [], propDecorators: { popoverEl: [{ type: i0.ViewChild, args: ['popoverEl', { isSignal: true }] }] } });
